...
"""
    par_solve(W::PetscWrap.PetscMat, I::PetscWrap.PetscMat, solver::IntervalSolverT, dir::String, vecr::PetscWrap.PetscVec, veci::PetscWrap.PetscVec)

Solves the eigenvalue problem by finding all solutions in between the given interval.
Typically, slice solve is more effective.
"""
