"""
    par_compute_spectrum(dir::String, surf_dir::String)

Solves the system PΦ = ω^2QΦ from inputs in the given directory.
Case with QFM coordinates.
"""
function par_compute_spectrum(dir::String, surf_dir::String)
    ...
    surfs = surfaces_from_file(surf_dir)
    ...
    par_construct(P, Q, prob, grids, surfs)
